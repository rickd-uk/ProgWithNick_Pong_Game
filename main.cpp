...
Color Green = Color{38, 185, 154, transparency};
Color Dark_Green = Color{20, 160, 133, transparency};
Color Light_Green = Color{129, 204, 184, transparency};
Color Yellow = Color{243, 213, 154, transparency};
